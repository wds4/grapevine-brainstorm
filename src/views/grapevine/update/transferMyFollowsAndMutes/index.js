...
const SingleEndpointControlPanel = ({ pubkey, action }) => {
  ...
  const url =
    'https://interpretation-brainstorm.vercel.app/api/manageData/singleUser/insertFollowsAndMutesIntoUsersTable?pubkey='+pubkey+'&nextStep=true'
      ...
      <CRow className="justify-content-center">
        <CCol>
          <CCard className="w-100">
            <CCardBody>
              <center>
                <CCardTitle>Transfer my follows and mutes into the users table</CCardTitle>
              </center>
            </CCardBody>
            <CCardBody>
