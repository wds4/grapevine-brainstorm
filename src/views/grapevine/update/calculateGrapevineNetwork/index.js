...
const SingleEndpointControlPanel = ({ pubkey, action }) => {
  ...
  const url =
    'https://calculation-brainstorm.vercel.app/api/grapevine/calculate/basicNetwork?name=default&pubkey=' + pubkey
      ...
      <CRow className="justify-content-center">
        <CCol>
          <CCard className="w-100">
            <CCardBody>
              <center>
                <CCardTitle>Calculate basic Grapevine Network</CCardTitle>
              </center>
            </CCardBody>
            <CCardBody>
