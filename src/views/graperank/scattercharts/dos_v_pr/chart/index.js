  ...
  return (
    <>
      <Chart
        ...
        style={{ height: '500px' }}
        options={{
          title: 'DoS versus PageRank for determination of your Web of Trust',
          hAxis: { title: 'DoS: Degree of Separation' },
          vAxis: { title: 'log(Personalized PageRank)' },
        }}
        legendToggle
      />
    </>
